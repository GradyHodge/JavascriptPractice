...
module.exports = {
  ...
  findById: function (req, res) {
    console.log("Find character by id request.");
  ...
  update: function (req, res) {
    ...
    if (!req.params.id || req.body === {}) {
      console.log("Missing data in character update request.");
      res.send({
      ...
      console.log(
        "Find one character and update request.",
        req.params.id,
        req.body
      );
  ...
  remove: function (req, res) {
    console.log("Remove character request.");
    // If a id is present then run delete
    if (req.params.id) {
      db.Character.findById(req.params.id)
        .then((dbCharacter) => dbCharacter.remove())
        .catch((err) =>
          res.send({
